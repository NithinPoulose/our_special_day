...
const ml: Translations = {
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer: 'സെന്റ് പയസ് ടെന്ത് ഓഡിറ്റോറിയം, ചൂണ്ടി, ആലുവ, എറണാകുളം. മുകളിലെ മാപ്പ് ലിങ്ക് തുറക്കുമ്പോൾ നേരെ വേദിയിലേക്ക് എത്താം.',
      },
      {
  ...
  venue: 'സെന്റ് പയസ് ടെന്ത് ഓഡിറ്റോറിയം',
